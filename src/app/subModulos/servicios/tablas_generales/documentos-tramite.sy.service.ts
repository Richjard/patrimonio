...
export class DocumentoTramiteSyService extends Subject<DataStateChangeEventArgs> { 
    ...
    protected getData(state: DataStateChangeEventArgs): Observable<DataStateChangeEventArgs> {
        ...
        this.insertHead();  
        return this.http 
           .post(`${environment.apiUrl}/pat/documentos_tramite/result`,this.parametros_consulta,this.httpOptions) 
