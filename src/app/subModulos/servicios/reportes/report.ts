...
DocumentoDesplazamiento(DesplazamientoBien :DesplazamientoBienInterface,dataBienEstado:EstadoBienInterface[]) {   
   ...
   let totalEstados=dataBienEstado.length;
   if(totalEstados>0) { 
    for (var itemEstado of dataBienEstado) {   
   ...
   let total=DesplazamientoBien.bienes.length;
   let totalC=0;
   
    if(total>0) { 
          for (var item of DesplazamientoBien.bienes) { 
        ...
        content: [
          {
            stack: [
              ...
              {text: 'N° '+DesplazamientoBien.iDespBienId+' - '+DesplazamientoBien.iYearId, style: 'subheader'},
            ],
  ...
  
          {
            ...
            columns: [
              ...
              {
                width: 90,
                text:DesplazamientoBien.dDespBienFecha,style: 'cabexeraTextConten' 
              }
            ]
          },
  
          {
            ...
            columns: [           
              ...
              {
                text:  DesplazamientoBien.cDepenNombre,style: 'cabexeraTextConten' 
              }
          ...
          {     
            columns: [
              ...
              {
                text: DesplazamientoBien.cCentroCostoNombre ,style: 'cabexeraTextConten'            
              }
            ]
          },
  ...
  
          {
            ...
            columns: [
              ...
              {
                width: 90,  
                text: DesplazamientoBien.cOrigenEpleadoDNI,style: 'cabexeraTextConten' 
              },
              {
                width: 90,
              ...
              {
                text: DesplazamientoBien.iOrigenEmpleado,style: 'cabexeraTextConten' 
              }
            ]
          },
          {
          ...
          },
          {
            ...
            columns: [
              {
                text: DesplazamientoBien.iOrigenEmpleado
              },
              {
                text: DesplazamientoBien.cEmpleadoO
              }
            ]
          },
          {
            ...
            columns: [
              {
                text: DesplazamientoBien.cDepenNombre
              },
              {
                text: DesplazamientoBien.cDepenNombreO
              }
            ]
          },
