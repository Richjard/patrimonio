...
export class CentroCostoSyService extends Subject<DataStateChangeEventArgs> { 
    ...
    protected getData(state: DataStateChangeEventArgs): Observable<DataStateChangeEventArgs> {
        ...
        this.insertHead();  
        return this.http 
           .post(`${environment.apiUrl}/pat/centro_costo_pat/result`,this.parametros_consulta,this.httpOptions) 
