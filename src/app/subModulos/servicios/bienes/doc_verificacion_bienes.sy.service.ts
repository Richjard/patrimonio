...
export class DocVerificacionBienSyService extends Subject<DataStateChangeEventArgs> { 
    ...
    protected getData(state: DataStateChangeEventArgs): Observable<DataStateChangeEventArgs> {
        ...
        this.insertHead();  
        return this.http 
           .post(`${environment.apiUrl}/pat/doc_verificacion/result`,this.parametros_consulta,this.httpOptions) 
