...
export class DesplazamientoBienSyService extends Subject<DataStateChangeEventArgs> { 
    ...
    protected getData(state: DataStateChangeEventArgs): Observable<DataStateChangeEventArgs> {
        ...
        this.insertHead();  
        return this.http 
           .put(`${environment.apiUrl}/pat/desplazamiento/result`,this.parametros_consulta,this.httpOptions) 
