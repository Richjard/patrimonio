...
import {DependenciaInterface} from '../../interfaces/tablasGenerales/dependencia-tablasGenerales-interface';
...
export class DependenciaService {
  ...
  constructor(private http:HttpClient,private store: LocalService,) {
   ...
   getCombo(): Observable<DependenciaInterface[]>{
    this.insertHead()
    return this.http.post<DependenciaInterface[]>(`${environment.apiUrl}/pat/centro_costo/combo`,this.httpOptions)
    .pipe(map(data => data));
   }
