...
public BtnImprimirDocumentoDesplazamientoClick: EmitType<object> = () => {   
  ...
  pdfMake.createPdf(this.DocumentoDesplazamiento()).open();
}
DocumentoDesplazamiento() {   
  var  items_: Object[] = [];
  ...
  /* [
     {text: 'eeeee 1', style: 'tableItem'},
     {text: 'Header 1', style: 'tableItem'},
     {text: 'Header 1', style: 'tableItem'},
     {text: 'Header 1', style: 'tableItem'},
     {text: 'Header 1', style: 'tableItem'},
     {text: 'Header 1', style: 'tableItem'},
 ...
 let totalEstados=this.dataBienEstado.length;
 if(totalEstados>0) { 
  for (var itemEstado of this.dataBienEstado) {   
    estadosText=estadosText+itemEstado['cEstadoBienDescripcion']+'('+itemEstado['cEstadoBienAbre']+') ';
 ...
 let total=this.DesplazamientoBien.bienes.length;
 let totalC=0;
 
  if(total>0) { 
        for (var item of this.DesplazamientoBien.bienes) { 
         // console.log("items:"+item['cBienSerie']);
         //item['cBienSerie']
         totalC=item['colores'].length;
         if(totalC>0) { 
          for (var itemC of item['colores']) { 
            ColorText=ColorText+itemC['cColorNombre']+' ';
          }
        }
         items_.push(
          [ {text: item['RowNumber'], style: 'tableItem'},
           ...
           {text: ColorText, style: 'tableItem'},
           {text: item['cEstadoBienAbre'], style: 'tableItem'},
           {text: item['cDespBienDetObs'], style: 'tableItem'},
         ] );
      ...
      content: [
        {
          stack: [
            ...
            {text: 'N° '+this.DesplazamientoBien.iDespBienId+' - '+this.DesplazamientoBien.iYearId, style: 'subheader'},
          ],
...

        {
          ...
          columns: [
            ...
            {
              width: 90,
              text:this.DesplazamientoBien.dDespBienFecha,style: 'cabexeraTextConten' 
            }
          ]
        },

        {
          ...
          columns: [           
            ...
            {
              text:  this.DesplazamientoBien.cDepenNombre,style: 'cabexeraTextConten' 
            }
        ...
        {     
          columns: [
            ...
            {
              text: this.DesplazamientoBien.cCentroCostoNombre ,style: 'cabexeraTextConten'            
            }
          ]
        },

        {
          ...
          columns: [
            {
              text: 'USUARIO RESPONSABLE', style: 'cabexeraText' 
            }           
          ]
        },

        {
          ...
          columns: [
            {
              width: 90,
              text: 'DNI:',style: 'cabexeraText' 
            },
            {
              width: 90,  
              text: this.DesplazamientoBien.cOrigenEpleadoDNI,style: 'cabexeraTextConten' 
            },
            {
              width: 90,
              text: 'APELLIDOS Y NOMBRES:', style: 'cabexeraText' 
            },
            {
              text: this.DesplazamientoBien.iOrigenEmpleado,style: 'cabexeraTextConten' 
            }
          ]
        },
        {
          ...
          columns: [
            {
              width: 90,
              text: 'CARGO:',  style: 'cabexeraText' 
            },
            {
              text: 'EEEEE',style: 'cabexeraTextConten' 
            },
            {
              width: 90,
              text: 'MODALIDAD:', style: 'cabexeraText' 
            },
            {
              text: 'FUNCIONARIO (   ) CAP (   )   CAS (   )   INVERSIONES (  )',style: 'cabexeraTextConten' 
            }
          ],
        ...
        {
          text: 'El trabajador es responsable Directo de la Existencia, permanencia, conservación y buen uso de cada uno de los bienes descritos por lo que se  recomienda tomar las providencias del caso para evitar pérdida, sustracción, deterioro, etc. cualquier movimiento del bien dentro o fuera de la  entidad deberá ser comunicado al encargado de Control Patrimonial, bajo responsabilidad.',
          fontSize: 8,
          color: 'gray',
          bold: true,
        },
        ...
        {
          alignment: 'center', margin: [0, 50, 0, 0],fontSize: 10,
          columns: [
            {
        ...
        },
        {
          ...
          columns: [
            {
              text: this.DesplazamientoBien.iOrigenEmpleado
            },
            {
              text: this.DesplazamientoBien.cEmpleadoO
            }
          ]
        },
        {
          ...
          columns: [
            {
              text: this.DesplazamientoBien.cDepenNombre
            },
            {
              text: this.DesplazamientoBien.cDepenNombreO
            }
          ]
        },
...
//VENTANA MODAL
 ...
 //   console.log(daten);//'2019-11-03'  2019-10-3
      ...
      this.setDesplazamientoBienDatos("autogenerado",daten,"",2,"",2019,'','','',[],'','');
...
constructor(private service:DesplazamientoBienSyService , private serviceCrud:DesplazamientoBienesService,private dataApiEstadoBienes:EstadosBienesService){
  this.data = service;
