...
import {CargoInterface} from '../../interfaces/tablasGenerales/cargo-tablasGenerales-interface';
...
export class CargosService {
  ...
  constructor(private http:HttpClient,private store: LocalService,) {
   ...
   getCombo(): Observable<CargoInterface[]>{
    this.insertHead()
    return this.http.post<CargoInterface[]>(`${environment.apiUrl}/pat/cargos/combo`,this.httpOptions)
    .pipe(map(data => data));
   }
