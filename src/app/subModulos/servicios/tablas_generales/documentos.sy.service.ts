...
export class DocumentoSyService extends Subject<DataStateChangeEventArgs> { 
    ...
    protected getData(state: DataStateChangeEventArgs): Observable<DataStateChangeEventArgs> {
        ...
        this.insertHead();  
        return this.http 
           .post(`${environment.apiUrl}/pat/documentos/result`,this.parametros_consulta,this.httpOptions) 
