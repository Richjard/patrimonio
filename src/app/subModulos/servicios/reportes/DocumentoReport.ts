...
export class DocumentoReportService {
  ...
  documento3(dataBienes){
   ...
   // let tipo =5;
    return {
      ...
      content: this.contenidoDocu(dataBienes),
  ...
  contenidoDocu(dataBienes){
   // let tipo;
      ...
      if(total>0) { 
        for (var item of dataBienes) { 
         items_.push(
           ...
           precioTotal = precioTotal + parseFloat(item['nBienValor']) ;
         }
      }   
      items_.push(
      ...
      items_.push(
        [ {text: 'Precio Total de los bienes:',colSpan: 9, alignment: 'right',style: 'tableItem'},
          {},{},{},{},{},{},{},{},{},
          {text: precioTotal.toFixed(2), style: 'tableItem'}
        ] );
      //fin item
      ...
      var contenido: Object[] = [];
        ...
        console.log("case 1 / bien no depreciable");
        contenido= [[
          {
            stack: [
              'REPORTE DE BIENES NO DEPRECIABLES'
            ],
            style: 'headerDocumento'          
          },
     ...
     documento4(dataBienes,CuentaMayor,Subcuenta){
     ...
     // let tipo =5;
      return {
        ...
        content: this.contenidoDocum(dataBienes,CuentaMayor,Subcuenta),
       ...
       contenidoDocum(dataBienes,CuentaMayor,Subcuenta){
        // let tipo;
           //armar e item
           var  items_: Object[] = [];
           items_=[
           ...
           var contenido: Object[] = [];
             ...
             console.log("case 2 / bien por plan");     
             contenido= [[
                 {
                   stack: [
                     'REPORTE TOTAL DE BIENES POR PlAN CONTABLE'
                   ],
                   style: 'headerDocumento'          
                 },
           ...
           
                 {
                   ...
                   columns: [           
                     {
                       width: 90,
                       text: 'CUENTA MAYOR:', style: 'cabexeraText' 
                     },
                     {
                       text:  CuentaMayor,style: 'cabexeraTextConten' 
                     }
                 ...
                 { 
                   columns: [           
                     {
                       width: 90,
                       text: 'SUB CUENTA:', style: 'cabexeraText' 
                     },
                     {
                       text:  Subcuenta, style: 'cabexeraTextConten' 
                     }
